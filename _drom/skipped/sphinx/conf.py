...
# -*- coding: utf-8 -*-
#
# openapi documentation build configuration file, created by
# sphinx-quickstart.
#
...
latex_documents = [
    (master_doc, 'openapi.tex', 'openapi Documentation',
     'author', 'manual'),
]
...
man_pages = [
    (master_doc, 'openapi', 'openapi Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'openapi', 'openapi Documentation',
     author, 'openapi', 'One line description of project.',
     'Miscellaneous'),
]
